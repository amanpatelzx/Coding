...
function CartItem({id, name , image, quantity}){
    ...
    return (
        <div className="cart-item">
            ...
            <div>
                <button className="yellow-button qty-button qty-plus-button" onClick={() => handleIncreaseQuantity(id)}>+</button>
            </div>
            <div>
                <button className="yellow-button qty-button qty-plus-button" onClick={() =>handleDecreaseQuantity(id)}>-</button> 
            </div>
        </div>
    );  
}
